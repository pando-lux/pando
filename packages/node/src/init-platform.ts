...
export async function initPlatform(node: any): Promise<void> {
    ...
    // Watchdog moved to supervisor.ts (BIBLE 1.9.2) — supervisor owns all restarts.
    // Node still exposes requestGracefulRestart() for the supervisor to trigger via exit code 75.
}
