...
import type { ReputationWeightedGovernance } from './reputation-governance.js';
...
export class GovernanceSync {
  ...
  // Phase 30.2: AgentManager for spawning reviewer agents
  ...
  setReputationGovernance(rg: ReputationWeightedGovernance): void {
  ...
  setPaymentGate(pg: PaymentGate): void {
    this.paymentGate = pg;
