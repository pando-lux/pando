        ...
        {loading && (
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="animate-pulse bg-neutral-200 dark:bg-neutral-700/50 rounded-lg h-20 w-full" />
              <div className="animate-pulse bg-neutral-200 dark:bg-neutral-700/50 rounded-lg h-14 w-full" />
              <div className="animate-pulse bg-neutral-200 dark:bg-neutral-700/50 rounded-lg h-14 w-3/4" />
            </div>
          </div>
        )}
